...
public class BoCooperCompanyActivity extends BaseActivity implements IViewCooperCompany {
    ...
    private void initListView(final CooperCompanyEntity entity) {
        ...
        swipeListView.getListView().setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                bundle.putLong("companyUuid", entity.getPageList().get(position).getUuid());
                startActivity(BoCooperAddActivity.class, bundle);
            }
        });
    }
