 ...
 */
public class DaiShouShouActivity extends BaseActivity implements IViewDaishou {
    ...
    public void initView() {
        ...
        llSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DaiShouShouActivity.this, ShouBillActivity.class);
        ...
        titlebar.setOnImageModeListener(new ZTitlebar.OnImageModeListener() {
            ...
            public void onClickImageModel() {
                IntentIntegrator integrator = new IntentIntegrator(DaiShouShouActivity.this);
    ...
    public void getError() {
        dialog.dismiss();
        Toasty.info(this, "票据不符合收款条件").show();
        isScan = true;
        edSao.setText("");
    }
