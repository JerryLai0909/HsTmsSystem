...
class Z_SwipeListView : RelativeLayout {
    ...
    private fun initView(context: Context) {
        ...
        var view = inflater!!.inflate(R.layout.z_swipe_listview, this, true)
        imError = view.findViewById(R.id.imError) as ImageView
        listView = view.findViewById(R.id.listView) as ListView
        swipeLayout = view.findViewById(R.id.swipeLayout_listView) as SwipeRefreshLayout
